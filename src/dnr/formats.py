...
SUPPORTED: dict[str, tuple[str, str, str, str]] = {
    ...
    ".flac": ("audio",       "asr (Whisper, local)",                      "Vorbis comment (in-file)", "partial"),
    ".ogg":  ("audio",       "asr (Whisper, local)",                      "Vorbis comment (in-file)", "partial"),
    ".opus": ("audio",       "asr (Whisper, local)",                      "Opus tags (in-file)", "partial"),
    ".m4a":  ("audio",       "asr (Whisper, local, audio extra)",         "MP4 freeform (in-file)", "partial"),
    # --- video ---
    ".mp4":  ("video",       "agent transcript / ASR + vision",           "MP4 freeform (in-file)", "partial"),
    ".mov":  ("video",       "agent transcript / ASR + vision",           "MP4 freeform (in-file)", "partial"),
